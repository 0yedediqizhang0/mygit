...
def main():
    real_text_file='test_documents/test_1_gold/1.txt'
    pred_text_file='test_documents/test_1_mine/1.txt'
    # prf_score('real_text.txt','corpus/test_p0.19999999999999996_11110.utf8','prf_tmp.txt',1111)
    F=prf_score('test_documents/test_1_gold/1.txt',pred_text_file,'prf_tmp.txt',1111,10)
